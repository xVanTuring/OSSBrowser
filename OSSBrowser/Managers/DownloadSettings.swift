...
final class DownloadSettings: ObservableObject {
    ...
    static let defaultPartSize: Int64 = 100 * 1024 * 1024      // 100 MB
    ...
    private enum Key {
        static let partSize = "download.partSize"
        static let multipartThreshold = "download.multipartThreshold"
        static let maxConcurrency = "download.maxConcurrency"
        static let maxPartRetry = "download.maxPartRetry"
    }
